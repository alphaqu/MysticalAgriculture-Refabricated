...
public class ReprocessorBlock extends BaseBlockEntity implements BlockEntityProvider {
	...
	public enum ReprocessorTier {
		...
		private final BiFunction<BlockPos, BlockState, ReprocessorBlockEntity> tileEntitySupplier;

		ReprocessorTier(String name, int operationTime, int fuelUsage, int fuelCapacity, BiFunction<BlockPos, BlockState, ReprocessorBlockEntity> tileEntitySupplier) {
			this.name = name;
		...
		public ReprocessorBlockEntity getNewTileEntity(BlockPos pos, BlockState state) {
